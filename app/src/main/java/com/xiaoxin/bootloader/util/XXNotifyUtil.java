...
//                requestCode, intent, FLAG);
     ...
     * @param content
     */
    public void notify_normal_singleLine(PendingIntent pendingIntent, int smallIcon,
     ...
     * @param content
     */
    public void notify_normal_moreLine(PendingIntent pendingIntent, int smallIcon, String ticker,
                                       String title, String content, boolean sound, boolean vibrate, boolean lights) {

        final int sdk = Build.VERSION.SDK_INT;
        if (sdk < Build.VERSION_CODES.JELLY_BEAN) {
            notify_normal_singleLine(pendingIntent, smallIcon, ticker, title, content, sound, vibrate, lights);
